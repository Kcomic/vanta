...
/**
 * Error boundary for the (shop) route group. Renders inside the [locale] layout (so the
 * NextIntlClientProvider is intact and copy is localized) and offers a retry via `reset`.
 */
